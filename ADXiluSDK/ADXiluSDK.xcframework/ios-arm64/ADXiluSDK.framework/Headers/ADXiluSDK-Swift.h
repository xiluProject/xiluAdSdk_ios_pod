...
@class NSString;
SWIFT_ENUM_FWD_DECL(NSInteger, ADXiluAdPlatform)
/// 广告信息基类
...
- (void)removeSplashAdWithAdInfo:(ADXiluAdInfo * _Nonnull)adInfo;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_ENUM_FWD_DECL(NSInteger, ADXiluNativeAdType)
/// 信息流广告信息
...
SWIFT_ENUM_FWD_DECL(NSInteger, ADXiluSplashAdStyle)
/// 开屏广告类
